      ...
      <div className="max-w-md w-full space-y-8 bg-[#1E1E1E] p-8 rounded-lg shadow-lg border border-[#E53935]/20">
        ...
        <form className="mt-8 space-y-6" onSubmit={handleSubmit}>
          ...
          <div className="flex items-center">
            ...
            <label htmlFor="terms" className="ml-2 block text-sm text-gray-400">
              I agree to the{' '}
              <Link to="/terms" className="font-medium text-[#E53935] hover:text-[#C62828]">
                Terms of Service
              </Link>{' '}
              and{' '}
              <Link to="/privacy" className="font-medium text-[#E53935] hover:text-[#C62828]">
                Privacy Policy
              </Link>
            </label>
          </div>
        ...
        <div className="text-center mt-4">
          <p className="text-sm text-gray-400">
            ...
            <Link to="/login" className="font-medium text-[#E53935] hover:text-[#C62828]">
              Sign in
            </Link>
          </p>
        </div>
